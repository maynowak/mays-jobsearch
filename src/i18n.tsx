...
const en: Dict = {
  ...
  "cv.selectAll": "Select all",
  "cv.deselectAll": "Deselect all",
  "cv.searchWithSelected": "Search with selected",
  "cv.selectedCount": "{count} selected",
  "cv.noneSelected": "None selected",
  ...
  "cv.statusModelSelection": "Select AI model",
  ...
  "cv.processingStep3": "Model",
  "cv.processingStep4": "Profile",
  "cv.processingStep5": "Anonymization",
  "cv.processingStep6": "Goal",
  "cv.processingStepSkill": "Skills",
  "cv.processingStep7": "Target",
  "cv.processingStep8": "Processing",
  "cv.processingStep9": "Complete",
  "cv.processingStep10": "Complete",
  "cv.processingStepImprovement": "Improvements",
  "cv.processingStepReanalysis": "Re-Analysis",
  "cv.processingStepMatchImpact": "Match Impact",
  ...
  "cv.skillSelectTitle": "Select Skills for Job Search",
  "cv.skillSelectDescription": "Choose which skills from your CV should be used for the job search. You can add or remove skills as needed.",
  "cv.skillSelectAdd": "Add skill",
  "cv.skillSelectPlaceholder": "Type a skill and press Enter",
  "cv.skillSelectNoSkills": "No skills selected. Please select at least one skill.",
  "cv.skillSelectContinue": "Continue with selected skills",
  "cv.modelSelect": "Select AI Model",
  "cv.modelSelectDescription": "Choose the AI model for CV processing. The model will be locked once processing starts.",
  "cv.modelSelectionLocked": "Model selection is locked during processing.",
  ...
  "cv.atsModelUnavailable": "The selected AI model is currently unavailable for this analysis. Please choose another model.",
  "cv.atsRetry": "Restart ATS analysis",
  ...
  "cv.comparisonBefore": "Before: {score}",
  "cv.comparisonAfter": "After: {score}",
  ...
  "cv.matchImpactTitle": "Match Impact Analysis",
  "cv.matchImpactDescription": "Compare job match scores before and after CV improvements.",
  "cv.matchImpactScoreLabel": "Match Score",
  "cv.matchImpactCoverageLabel": "Coverage",
  "cv.matchImpactBeforeLabel": "Before Improvements",
  "cv.matchImpactAfterLabel": "After Improvements",
  "cv.matchImpactDeltaLabel": "Change",
  "cv.matchImpactImproved": "Improved",
  "cv.matchImpactUnchanged": "Unchanged",
  "cv.matchImpactRegressed": "Regressed",
  "cv.matchImpactNoChanges": "No measurable changes detected.",
  "cv.matchImpactRunAnalysis": "Run Match Impact Analysis",
  "cv.matchImpactRunning": "Running match impact analysis…",
  "cv.matchImpactComplete": "Match impact analysis complete.",
  "cv.matchImpactError": "Match impact analysis failed. Please try again.",
  "cv.matchImpactNoJob": "No job selected for match impact analysis.",
  "cv.matchImpactBack": "Back to comparison",
  ...
  "error.boundaryMessage": "An unexpected error occurred. The page can be reloaded to continue.",
...
const de: Dict = {
  ...
  "cv.selectAll": "Alle auswählen",
  "cv.deselectAll": "Alle abwählen",
  "cv.searchWithSelected": "Mit ausgewählten suchen",
  "cv.selectedCount": "{count} ausgewählt",
  "cv.noneSelected": "Keine ausgewählt",
  ...
  "cv.statusModelSelection": "KI-Modell auswählen",
  ...
  "cv.processingStep3": "Modell",
  "cv.processingStep4": "Profil",
  "cv.processingStep5": "Anonymisierung",
  "cv.processingStep6": "Zielrolle",
  "cv.processingStepSkill": "Skills",
  "cv.processingStep7": "Verarbeitung",
  "cv.processingStep8": "Abgeschlossen",
  "cv.processingStep9": "Abgeschlossen",
  "cv.processingStep10": "Abgeschlossen",
  "cv.processingStepImprovement": "Verbesserungen",
  "cv.processingStepReanalysis": "Re-Analyse",
  "cv.processingStepMatchImpact": "Match Impact",
  ...
  "cv.skillSelectTitle": "Skills für die Jobsuche auswählen",
  "cv.skillSelectDescription": "Wählen Sie aus, welche Skills aus Ihrem Lebenslauf für die Jobsuche verwendet werden sollen. Sie können Skills hinzufügen oder entfernen.",
  "cv.skillSelectAdd": "Skill hinzufügen",
  "cv.skillSelectPlaceholder": "Skill eingeben und Enter drücken",
  "cv.skillSelectNoSkills": "Keine Skills ausgewählt. Bitte wählen Sie mindestens einen Skill.",
  "cv.skillSelectContinue": "Mit ausgewählten Skills fortfahren",
  "cv.modelSelect": "KI-Modell auswählen",
  "cv.modelSelectDescription": "Wählen Sie das KI-Modell für die CV-Verarbeitung. Das Modell wird gesperrt, sobald die Verarbeitung startet.",
  "cv.modelSelectionLocked": "Modellauswahl ist während der Verarbeitung gesperrt.",
  ...
  "cv.atsModelUnavailable": "Das ausgewählte KI-Modell ist für diese Analyse momentan nicht verfügbar. Bitte wähle ein anderes Modell.",
  "cv.atsRetry": "ATS-Analyse erneut starten",
...
"cv.comparisonCoverageLabel": "Keyword Coverage",
  "cv.comparisonRequirementsLabel": "Requirements",
  "cv.comparisonBefore": "Vorher: {score}",
  "cv.comparisonAfter": "Nachher: {score}",
  "cv.comparisonImproved": "Verbessert",
  "cv.comparisonUnchanged": "Unverändert",
  "cv.comparisonRegressed": "Verschlechtert",
  "cv.comparisonNoChanges": "Keine messbaren Änderungen erkannt.",
  "cv.comparisonBack": "Zurück zu Verbesserungen",

  "cv.matchImpactTitle": "Match Impact Analysis",
  "cv.matchImpactDescription": "Vergleichen Sie Job-Match-Scores vor und nach CV-Verbesserungen.",
  "cv.matchImpactScoreLabel": "Match Score",
  "cv.matchImpactCoverageLabel": "Abdeckung",
  "cv.matchImpactBeforeLabel": "Vor Verbesserungen",
  "cv.matchImpactAfterLabel": "Nach Verbesserungen",
  "cv.matchImpactDeltaLabel": "Änderung",
  "cv.matchImpactImproved": "Verbessert",
  "cv.matchImpactUnchanged": "Unverändert",
  "cv.matchImpactRegressed": "Verschlechtert",
  "cv.matchImpactNoChanges": "Keine messbaren Änderungen erkannt.",
  "cv.matchImpactRunAnalysis": "Match Impact Analyse starten",
  "cv.matchImpactRunning": "Match Impact Analyse läuft…",
  "cv.matchImpactComplete": "Match Impact Analyse abgeschlossen.",
  "cv.matchImpactError": "Match Impact Analyse fehlgeschlagen. Bitte versuchen Sie es erneut.",
  "cv.matchImpactNoJob": "Kein Job für Match Impact Analyse ausgewählt.",
  "cv.matchImpactBack": "Zurück zum Vergleich",
  ...
  "error.boundaryTitle": "Etwas ist schiefgelaufen",
  "error.boundaryMessage": "Ein unerwarteter Fehler ist aufgetreten. Die Seite kann neu geladen werden, um fortzufahren.",
  "error.boundaryReload": "Seite neu laden",
