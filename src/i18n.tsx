...
const en: Dict = {
  ...
  "cv.skillSelectTitleAts": "Select skills for the ATS analysis",
  "cv.skillSelectDescriptionAts": "Choose which skills from your CV should be checked against the job requirements. You can add or remove skills as needed.",
...
const de: Dict = {
  ...
  "cv.skillSelectTitleAts": "Skills für die ATS-Analyse auswählen",
  "cv.skillSelectDescriptionAts": "Wählen Sie aus, welche Skills aus Ihrem Lebenslauf gegen Stellenanforderungen geprüft werden sollen. Sie können Skills hinzufügen oder entfernen.",
